...
class SolveStrategy(Enum):
    ...
    LB_LP = 'LB_LP'
    MIXED_ILP_OPTIMAL = 'MIXED_ILP_OPTIMAL'
    MIXED_ILP_APPROXIMATE = 'MIXED_ILP_APPROXIMATE'
    ...
    def get_description(cls, val, model_name=None):
        ...
        return {
            ...
            cls.MIXED_ILP_OPTIMAL: "Using mixed swap and recompute",
            cls.MIXED_ILP_APPROXIMATE: "Mixed swap and recompute with approximation",
        }[val]
    ...
    def get_plot_params(cls, val):
        ...
        mapping = {
            ...
            cls.MIXED_ILP_OPTIMAL: ("pink", "^", fullsize),
            cls.MIXED_ILP_APPROXIMATE: ("yellow", "*", fullsize),
        }
        if val in mapping:
            return mapping[val]
    ...
    def get_version(cls, val):
        return {
            ...
            cls.LB_LP: "v1.1",
            cls.MIXED_ILP_OPTIMAL: "v0.1",
            cls.MIXED_ILP_APPROXIMATE: "v0.1",
        }[val]
