...
from remat.core.solvers.strategy_hybrid_approxi import solve_hybrid_approximate_lp
...
if __name__ == "__main__":
    ...
    for solve_strategy, results in result_dict.items():
        ...
        logger.info(f"Strategy {solve_strategy} has {len(data_points)} samples from {len(results)}，results: \n {data_points}")
