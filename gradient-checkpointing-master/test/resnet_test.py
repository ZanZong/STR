...
# os.environ['TF_CPP_MIN_LOG_LEVEL']='1'  # silence tf init messages
os.environ['TF_CPP_MIN_VLOG_LEVEL']='3'  # silence tf init messages
...
def main():
  ...
  assert memuse < 720, "got %.1f usage" %(memuse,)
