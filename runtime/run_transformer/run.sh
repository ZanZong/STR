...
nohup python ../run_training.py --model-name transformer --epoch 1 --batch-size 210 --strategy chen-heurist > chen-heurist-b210.log 2>&1
nohup python ../run_training.py --model-name transformer --epoch 1 --batch-size 230 --strategy chen-heurist > chen-heurist-b230.log 2>&1
nohup python ../run_training.py --model-name transformer --epoch 1 --batch-size 250 --strategy chen-heurist > chen-heurist-b250.log 2>&1
nohup python ../run_training.py --model-name transformer --epoch 1 --batch-size 270 --strategy chen-heurist > chen-heurist-b270.log 2>&1
nohup python ../run_training.py --model-name transformer --epoch 1 --batch-size 290 --strategy chen-heurist > chen-heurist-b290.log 2>&1